...
class Categories
{
	...
	#[McpTool(
		name: 'banners_categories_trash',
		description: 'Moves a banner category to the trash by setting its state to -2',
	...
	#[McpTool(
		...
		description: 'Permanently deletes a banner category. Automatically trashes it first if needed.',
		annotations: new ToolAnnotations(destructiveHint: true)
	)]
