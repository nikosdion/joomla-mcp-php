...
/**
 * MCP elements for Joomla! site modules management
 */
class SiteModules
{
	...
	#[McpTool(
		name: 'modules_site_list',
		description: 'List existing site modules',
	...
	#[McpTool(
		name: 'modules_site_read',
		description: 'Retrieve the information of the specified site module',
		annotations: new ToolAnnotations(readOnlyHint: true)
	)]
	...
	#[McpTool(
		name: 'modules_site_create',
		description: 'Create a new site module'
	)]
	...
	#[McpTool(
		name: 'modules_site_update',
		description: 'Update an existing site module',
	...
	#[McpTool(
		name: 'modules_site_types',
		description: 'List available site module types',
		annotations: new ToolAnnotations(readOnlyHint: true)
	)]
